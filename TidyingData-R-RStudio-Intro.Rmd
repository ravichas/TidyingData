...
author: "Dr. Sarangan Ravichandran and Randall Johnson"
...
install.packages("foreign")  # to install foreign package
require(foreign)  # to load foreign package
#or
library(foreign) 
...
# case sensitive 
getwd() 
Getwd()  # correct command is getwd() 
...
Data<-data.frame(Country,PerCapitaIncome)
States<-c(50, 23,31)
Data1<-cbind(Data,States)


Country<-c("India")
PerCapitaIncome<-c(1450)
States<-c(28)
Ndata<-data.frame(Country,PerCapitaIncome,States)
FinData<-rbind(Data1,Ndata)
...
## Exercuse:
Let us read the Wisconsin Dataset to answer the following questions? 
