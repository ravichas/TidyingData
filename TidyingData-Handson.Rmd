...
knitr::opts_knit$set(root.dir = "C:/Users/ravichandrans/Desktop/BTEP")
print(getwd())
```
...
- modern way or loooking at data.frame 
...
- Doesnt add new names or modify
...
How to add a row in an existing tibble?
