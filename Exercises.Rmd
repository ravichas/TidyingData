...
This file will provide human readable labels for the codes in the nss15 data set. You may also find the `get_label()` function in this file useful. For example, if you want to get body part codes for `c(0, 33, 37, 33)`, you could do it like so:
